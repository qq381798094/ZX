...
enum API {
  ...
  // 删除已有的 SPU 数据
  DELETE_SPU_DATA_BY_ID__URL = '/admin/product/deleteSpu/',
}
...
// 删除已有的 SPU 数据
export const requestDelSpuDataByIdAPI = (spuId: number) =>
  request.delete<any, ISpuResponseData<string | null>>(API.DELETE_SPU_DATA_BY_ID__URL + spuId)
